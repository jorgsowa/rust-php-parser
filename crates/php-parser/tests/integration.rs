...
// error handling
fixture_test!(errorhandling_eoferror_1, "nikic/errorHandling/eofError_1.php", errors);
fixture_test!(errorhandling_eoferror_2, "nikic/errorHandling/eofError_2.php", errors);
fixture_test!(errorhandling_lexererrors_1, "nikic/errorHandling/lexerErrors_1.php");
fixture_test!(errorhandling_lexererrors_5, "nikic/errorHandling/lexerErrors_5.php", errors);
fixture_test!(errorhandling_recovery_1, "nikic/errorHandling/recovery_1.php", errors);
fixture_test!(errorhandling_recovery_2, "nikic/errorHandling/recovery_2.php", errors);
fixture_test!(errorhandling_recovery_3, "nikic/errorHandling/recovery_3.php", errors);
fixture_test!(errorhandling_recovery_4, "nikic/errorHandling/recovery_4.php", errors);
fixture_test!(errorhandling_recovery_5, "nikic/errorHandling/recovery_5.php", errors);
fixture_test!(errorhandling_recovery_6, "nikic/errorHandling/recovery_6.php", errors);
fixture_test!(errorhandling_recovery_7, "nikic/errorHandling/recovery_7.php", errors);
fixture_test!(errorhandling_recovery_8, "nikic/errorHandling/recovery_8.php", errors);
fixture_test!(errorhandling_recovery_9, "nikic/errorHandling/recovery_9.php", errors);
fixture_test!(errorhandling_recovery_10, "nikic/errorHandling/recovery_10.php", errors);
fixture_test!(errorhandling_recovery_11, "nikic/errorHandling/recovery_11.php", errors);
fixture_test!(errorhandling_recovery_12, "nikic/errorHandling/recovery_12.php", errors);
fixture_test!(errorhandling_recovery_13, "nikic/errorHandling/recovery_13.php", errors);
fixture_test!(errorhandling_recovery_14, "nikic/errorHandling/recovery_14.php", errors);
fixture_test!(errorhandling_recovery_15, "nikic/errorHandling/recovery_15.php", errors);
fixture_test!(errorhandling_recovery_16, "nikic/errorHandling/recovery_16.php", errors);
fixture_test!(errorhandling_recovery_17, "nikic/errorHandling/recovery_17.php", errors);
fixture_test!(errorhandling_recovery_18, "nikic/errorHandling/recovery_18.php");
fixture_test!(errorhandling_recovery_19, "nikic/errorHandling/recovery_19.php", errors);
fixture_test!(errorhandling_recovery_20, "nikic/errorHandling/recovery_20.php", errors);
fixture_test!(errorhandling_recovery_21, "nikic/errorHandling/recovery_21.php", errors);
fixture_test!(errorhandling_recovery_22, "nikic/errorHandling/recovery_22.php", errors);
fixture_test!(errorhandling_recovery_23, "nikic/errorHandling/recovery_23.php", errors);
fixture_test!(errorhandling_recovery_24, "nikic/errorHandling/recovery_24.php", errors);
fixture_test!(errorhandling_recovery_25, "nikic/errorHandling/recovery_25.php", errors);
fixture_test!(errorhandling_recovery_26, "nikic/errorHandling/recovery_26.php", errors);

// expr
fixture_test!(expr_alternative_array_syntax_1, "nikic/expr/alternative_array_syntax_1.php");
fixture_test!(expr_alternative_array_syntax_2, "nikic/expr/alternative_array_syntax_2.php");
fixture_test!(expr_arraydef, "nikic/expr/arrayDef.php");
fixture_test!(expr_arraydestructuring, "nikic/expr/arrayDestructuring.php");
fixture_test!(expr_arrayemptyelemens, "nikic/expr/arrayEmptyElemens.php", errors);
...
fixture_test!(expr_closure_use_trailing_comma, "nikic/expr/closure_use_trailing_comma.php");
...
fixture_test!(expr_fetchandcall_constfetch, "nikic/expr/fetchAndCall/constFetch.php");
fixture_test!(expr_fetchandcall_constantderef, "nikic/expr/fetchAndCall/constantDeref.php");
fixture_test!(expr_fetchandcall_funccall, "nikic/expr/fetchAndCall/funcCall.php");
fixture_test!(expr_fetchandcall_namedargs, "nikic/expr/fetchAndCall/namedArgs.php");
fixture_test!(expr_fetchandcall_newderef, "nikic/expr/fetchAndCall/newDeref.php");
fixture_test!(expr_fetchandcall_objectaccess, "nikic/expr/fetchAndCall/objectAccess.php");
fixture_test!(expr_fetchandcall_simplearrayaccess, "nikic/expr/fetchAndCall/simpleArrayAccess.php");
fixture_test!(expr_fetchandcall_staticcall, "nikic/expr/fetchAndCall/staticCall.php");
fixture_test!(expr_fetchandcall_staticpropertyfetch, "nikic/expr/fetchAndCall/staticPropertyFetch.php");
fixture_test!(expr_firstclasscallables, "nikic/expr/firstClassCallables.php");
...
fixture_test!(expr_keywordsinnamespacedname, "nikic/expr/keywordsInNamespacedName.php");
...
fixture_test!(expr_newwithoutclass, "nikic/expr/newWithoutClass.php", errors);
...
fixture_test!(expr_uvs_globalnonsimplevarerror, "nikic/expr/uvs/globalNonSimpleVarError.php", errors);
...
fixture_test!(expr_uvs_newinstanceofexpr, "nikic/expr/uvs/newInstanceofExpr.php");
...
fixture_test!(scalar_numberseparators, "nikic/scalar/numberSeparators.php", errors);
...
fixture_test!(stmt_class_asymmetric_visibility_1, "nikic/stmt/class/asymmetric_visibility_1.php");
fixture_test!(stmt_class_asymmetric_visibility_2, "nikic/stmt/class/asymmetric_visibility_2.php");
fixture_test!(stmt_class_class_position_1, "nikic/stmt/class/class_position_1.php");
fixture_test!(stmt_class_class_position_2, "nikic/stmt/class/class_position_2.php");
fixture_test!(stmt_class_class_position_3, "nikic/stmt/class/class_position_3.php");
fixture_test!(stmt_class_conditional, "nikic/stmt/class/conditional.php");
fixture_test!(stmt_class_constmodifiererrors_1, "nikic/stmt/class/constModifierErrors_1.php", errors);
fixture_test!(stmt_class_constmodifiererrors_2, "nikic/stmt/class/constModifierErrors_2.php", errors);
fixture_test!(stmt_class_constmodifiererrors_3, "nikic/stmt/class/constModifierErrors_3.php", errors);
fixture_test!(stmt_class_constmodifiererrors_4, "nikic/stmt/class/constModifierErrors_4.php", errors);
fixture_test!(stmt_class_constmodifiers, "nikic/stmt/class/constModifiers.php");
fixture_test!(stmt_class_enum, "nikic/stmt/class/enum.php", errors);
fixture_test!(stmt_class_enum_with_string, "nikic/stmt/class/enum_with_string.php");
fixture_test!(stmt_class_final, "nikic/stmt/class/final.php");
fixture_test!(stmt_class_implicitpublic, "nikic/stmt/class/implicitPublic.php");
fixture_test!(stmt_class_interface, "nikic/stmt/class/interface.php");
fixture_test!(stmt_class_modifier_error_1, "nikic/stmt/class/modifier_error_1.php", errors);
fixture_test!(stmt_class_modifier_error_2, "nikic/stmt/class/modifier_error_2.php", errors);
fixture_test!(stmt_class_modifier_error_3, "nikic/stmt/class/modifier_error_3.php", errors);
fixture_test!(stmt_class_modifier_error_4, "nikic/stmt/class/modifier_error_4.php", errors);
fixture_test!(stmt_class_modifier_error_5, "nikic/stmt/class/modifier_error_5.php", errors);
fixture_test!(stmt_class_modifier_error_6, "nikic/stmt/class/modifier_error_6.php", errors);
fixture_test!(stmt_class_modifier_error_7, "nikic/stmt/class/modifier_error_7.php", errors);
fixture_test!(stmt_class_modifier_error_8, "nikic/stmt/class/modifier_error_8.php", errors);
...
fixture_test!(stmt_class_propertytypes, "nikic/stmt/class/propertyTypes.php");
fixture_test!(stmt_class_property_hooks_1, "nikic/stmt/class/property_hooks_1.php");
fixture_test!(stmt_class_property_hooks_2, "nikic/stmt/class/property_hooks_2.php");
fixture_test!(stmt_class_property_hooks_3, "nikic/stmt/class/property_hooks_3.php");
fixture_test!(stmt_class_property_hooks_4, "nikic/stmt/class/property_hooks_4.php", errors);
fixture_test!(stmt_class_property_hooks_5, "nikic/stmt/class/property_hooks_5.php", errors);
fixture_test!(stmt_class_property_hooks_6, "nikic/stmt/class/property_hooks_6.php", errors);
fixture_test!(stmt_class_property_hooks_7, "nikic/stmt/class/property_hooks_7.php", errors);
fixture_test!(stmt_class_property_modifiers, "nikic/stmt/class/property_modifiers.php");
fixture_test!(stmt_class_property_promotion, "nikic/stmt/class/property_promotion.php");
...
fixture_test!(stmt_class_readonlyanonyous, "nikic/stmt/class/readonlyAnonyous.php");
fixture_test!(stmt_class_readonlyasclassname_1, "nikic/stmt/class/readonlyAsClassName_1.php", errors);
fixture_test!(stmt_class_readonlyasclassname_2, "nikic/stmt/class/readonlyAsClassName_2.php", errors);
fixture_test!(stmt_class_readonlymethod, "nikic/stmt/class/readonlyMethod.php");
fixture_test!(stmt_class_shortechoasidentifier, "nikic/stmt/class/shortEchoAsIdentifier.php", errors);
fixture_test!(stmt_class_simple, "nikic/stmt/class/simple.php");
fixture_test!(stmt_class_staticmethod_1, "nikic/stmt/class/staticMethod_1.php");
fixture_test!(stmt_class_staticmethod_2, "nikic/stmt/class/staticMethod_2.php");
fixture_test!(stmt_class_staticmethod_3, "nikic/stmt/class/staticMethod_3.php");
fixture_test!(stmt_class_staticmethod_4, "nikic/stmt/class/staticMethod_4.php");
fixture_test!(stmt_class_staticmethod_5, "nikic/stmt/class/staticMethod_5.php");
fixture_test!(stmt_class_staticmethod_6, "nikic/stmt/class/staticMethod_6.php");
...
fixture_test!(stmt_class_typedconstants, "nikic/stmt/class/typedConstants.php");
...
fixture_test!(stmt_function_builtintypedeclarations, "nikic/stmt/function/builtinTypeDeclarations.php");
fixture_test!(stmt_function_byref, "nikic/stmt/function/byRef.php");
fixture_test!(stmt_function_clone_function, "nikic/stmt/function/clone_function.php");
fixture_test!(stmt_function_conditional, "nikic/stmt/function/conditional.php");
fixture_test!(stmt_function_defaultvalues, "nikic/stmt/function/defaultValues.php");
fixture_test!(stmt_function_disjointnormalformtypes, "nikic/stmt/function/disjointNormalFormTypes.php");
fixture_test!(stmt_function_exit_die_function, "nikic/stmt/function/exit_die_function.php");
fixture_test!(stmt_function_intersectiontypes, "nikic/stmt/function/intersectionTypes.php");
fixture_test!(stmt_function_nevertype, "nikic/stmt/function/neverType.php");
fixture_test!(stmt_function_nullfalsetruetypes_1, "nikic/stmt/function/nullFalseTrueTypes_1.php");
fixture_test!(stmt_function_nullfalsetruetypes_2, "nikic/stmt/function/nullFalseTrueTypes_2.php");
fixture_test!(stmt_function_nullabletypes, "nikic/stmt/function/nullableTypes.php");
fixture_test!(stmt_function_parameters_trailing_comma_1, "nikic/stmt/function/parameters_trailing_comma_1.php");
fixture_test!(stmt_function_parameters_trailing_comma_2, "nikic/stmt/function/parameters_trailing_comma_2.php");
fixture_test!(stmt_function_parameters_trailing_comma_3, "nikic/stmt/function/parameters_trailing_comma_3.php");
fixture_test!(stmt_function_readonlyfunction, "nikic/stmt/function/readonlyFunction.php");
fixture_test!(stmt_function_returntypes, "nikic/stmt/function/returnTypes.php");
fixture_test!(stmt_function_specialvars, "nikic/stmt/function/specialVars.php");
fixture_test!(stmt_function_typedeclarations, "nikic/stmt/function/typeDeclarations.php");
fixture_test!(stmt_function_typeversions_1, "nikic/stmt/function/typeVersions_1.php");
fixture_test!(stmt_function_typeversions_2, "nikic/stmt/function/typeVersions_2.php");
fixture_test!(stmt_function_typeversions_3, "nikic/stmt/function/typeVersions_3.php");
fixture_test!(stmt_function_typeversions_4, "nikic/stmt/function/typeVersions_4.php");
fixture_test!(stmt_function_typeversions_5, "nikic/stmt/function/typeVersions_5.php");
fixture_test!(stmt_function_typeversions_6, "nikic/stmt/function/typeVersions_6.php");
fixture_test!(stmt_function_uniontypes, "nikic/stmt/function/unionTypes.php");
fixture_test!(stmt_function_variadic, "nikic/stmt/function/variadic.php");
fixture_test!(stmt_function_variadicdefaultvalue, "nikic/stmt/function/variadicDefaultValue.php");
fixture_test!(stmt_generator_basic, "nikic/stmt/generator/basic.php");
fixture_test!(stmt_generator_yieldprecedence, "nikic/stmt/generator/yieldPrecedence.php");
fixture_test!(stmt_generator_yieldunaryprecedence, "nikic/stmt/generator/yieldUnaryPrecedence.php");
...
fixture_test!(stmt_haltcompilerinvalidsyntax, "nikic/stmt/haltCompilerInvalidSyntax.php", errors);
fixture_test!(stmt_haltcompileroffset, "nikic/stmt/haltCompilerOffset.php");
fixture_test!(stmt_haltcompileroutermostscope, "nikic/stmt/haltCompilerOutermostScope.php", errors);
...
fixture_test!(stmt_namespace_commentafternamespace, "nikic/stmt/namespace/commentAfterNamespace.php");
fixture_test!(stmt_namespace_groupuse, "nikic/stmt/namespace/groupUse.php");
fixture_test!(stmt_namespace_groupuseerrors_1, "nikic/stmt/namespace/groupUseErrors_1.php", errors);
fixture_test!(stmt_namespace_groupuseerrors_2, "nikic/stmt/namespace/groupUseErrors_2.php", errors);
fixture_test!(stmt_namespace_groupuseerrors_3, "nikic/stmt/namespace/groupUseErrors_3.php", errors);
fixture_test!(stmt_namespace_groupusepositions, "nikic/stmt/namespace/groupUsePositions.php");
fixture_test!(stmt_namespace_groupusetrailingcomma, "nikic/stmt/namespace/groupUseTrailingComma.php");
fixture_test!(stmt_namespace_invalidname_1, "nikic/stmt/namespace/invalidName_1.php", errors);
fixture_test!(stmt_namespace_invalidname_2, "nikic/stmt/namespace/invalidName_2.php", errors);
fixture_test!(stmt_namespace_invalidname_3, "nikic/stmt/namespace/invalidName_3.php", errors);
...
fixture_test!(stmt_namespace_notbraced, "nikic/stmt/namespace/notBraced.php");
fixture_test!(stmt_namespace_nsafterhashbang, "nikic/stmt/namespace/nsAfterHashbang.php");
fixture_test!(stmt_namespace_outsidestmt_1, "nikic/stmt/namespace/outsideStmt_1.php");
fixture_test!(stmt_namespace_outsidestmt_2, "nikic/stmt/namespace/outsideStmt_2.php");
fixture_test!(stmt_namespace_outsidestmtinvalid_1, "nikic/stmt/namespace/outsideStmtInvalid_1.php");
fixture_test!(stmt_namespace_outsidestmtinvalid_2, "nikic/stmt/namespace/outsideStmtInvalid_2.php");
fixture_test!(stmt_namespace_outsidestmtinvalid_3, "nikic/stmt/namespace/outsideStmtInvalid_3.php");
...
fixture_test!(stmt_trycatch_without_variable, "nikic/stmt/tryCatch_without_variable.php");
fixture_test!(stmt_trywithoutcatch, "nikic/stmt/tryWithoutCatch.php", errors);
