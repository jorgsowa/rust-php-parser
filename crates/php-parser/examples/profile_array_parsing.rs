...
fn main() {
    ...
    let code1 = "<?php $a = [".to_string()
        + &(1..=100)
            ...
            .join(", ")
        + "];";
    php_rs_parser::parse_arena(&arena, &code1);
    ...
    code2.push_str("];");
    php_rs_parser::parse_arena(&arena, &code2);
    instrument::report_stats();
    ...
    code3.push_str("];");
    php_rs_parser::parse_arena(&arena, &code3);
    instrument::report_stats();
    ...
    code4.push_str("];");
    php_rs_parser::parse_arena(&arena, &code4);
    instrument::report_stats();
    ...
    let code5 = "<?php $e = [[1, 2, 3], [4, 5, 6], [7, 8, 9], \
                           ['a' => 10, 'b' => 20], \
                           ['x' => [1, 2], 'y' => [3, 4]]];";
    php_rs_parser::parse_arena(&arena, code5);
    instrument::report_stats();
    ...
    code6.push_str("];");
    php_rs_parser::parse_arena(&arena, &code6);
    instrument::report_stats();
